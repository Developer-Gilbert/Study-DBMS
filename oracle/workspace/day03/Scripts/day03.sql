...
CREATE TABLE TBL_ANIMAL(
	...
	ANIMAL_KIND VARCHAR2(500),
	ANIMAL_DISEASE_NAME VARCHAR2(500),
	CONSTRAINT PK_ANIMAL PRIMARY KEY(ANIMAL_NAME, ANIMAL_KIND, ANIMAL_DISEASE_NAME)
);

CREATE TABLE TBL_PERSON(
	PERSON_NAME VARCHAR2(500),
	PERSON_AGE NUMBER NOT NULL,
	PERSON_ADDRESS VARCHAR2 NOT NULL,
	PERSON_PHONNUMBER NUMBER NOT NULL,
	CONSTRAINT 
);
